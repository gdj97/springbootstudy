...
import kr.gdu.shop3.dto.MailDto;
...
public class AdminController {
	...
	public String mailform(String[] idchks, Model model) {
		...
		List<UserDto> list = service.getUserList(idchks);
	...
	@PostMapping("mail")
	public String mail(@Valid MailDto mail,BindingResult bresult,Model model,HttpServletRequest request) {
	...
	private boolean mailSend(MailDto mail, Properties prop) {
